...
class Test extends Base{
  ...
  public function listGroups(){
    ...
    $testGroupFolders = glob($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/Tests/*'), GLOB_ONLYDIR);
  ...
  function generate($className){
    ...
    if(strpos($className, ':') !== false){
        ...
        $f = $this->fixPath(__DIR__ . '/../../../kws-api-starter/test/tests/'.$dir);
        if(!file_exists($f) || !is_dir($f)){
            mkdir($f);
        }
    }else{
        $f = $this->fixPath(__DIR__ . '/../../../kws-api-starter/test/Tests');
    }
...
class $className extends \Tests\TestBase{
  ...
  function start($groupName = null){
    ...
    require_once($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/_bootstrap.php'));
    require_once($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/_config.php'));
    require_once($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/_modelsList.php'));
    require_once($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/_viewsList.php'));
    ...
    $baseGroupTests = glob($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/Tests/*Test.php'));
    $testGroupFolders = glob($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/Tests/*'), GLOB_ONLYDIR);
    ...
    foreach ($testGroupFolders as $dir) {
        ...
        $namespace = end($ex);
        $toRun[$namespace] = [
            'files' => glob($this->fixPath(__DIR__ . '/../../../kws-api-starter/test/Tests/'.$namespace.'/*Test.php')),
            'namespace' => $namespace,
            'name' => $namespace
        ];
    }
